...
public class MessengerDialog extends javax.swing.JDialog {
     ...
     */
    public MessengerDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MessengerDialog.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                MessengerDialog dialog = new MessengerDialog(new javax.swing.JFrame(), true);
    ...
    void handleMessage(String input) {
        ...
        String msg = input.substring(thirdIndex+1);
        messageTextArea.append(this.buddyUsername + ": " + msg + '\n');
    }
